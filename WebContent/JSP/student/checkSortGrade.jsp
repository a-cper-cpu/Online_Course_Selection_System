...
<body>
	...
	<%
		...
		try {
			...
			String sql = "select cId,sId,grade,(@rowNum:=@rowNum+1) "
					+ "as rowNo from choosecourse,(select (@rowNum :=0) ) b where cId='" + cId + "' and sId='" + sId
					+ "' order by choosecourse.grade desc ";
