...
<body>
	...
	<%
		...
		try {
			...
			while (rs.next()) {
				...
				sMobil = rs.getString(4);
				request.setAttribute("sMobil", sMobil);
	...
	<form action="checkpersonal_information.jsp" method="post">
		<table>
			<tr>
				<td>学号：<input type="text" name="sId" value=<%=sId%>
					readonly="true" /></td>
				<td>&nbsp;</td>
				<td>姓名：<input type="text" name="sName" value=<%=sName%>
					readonly="true" /></td>
				<td>&nbsp;</td>
				<td>性别：<input type="text" name="sSex" value=<%=sSex%>
					readonly="true" /></td>
			</tr>
			<tr>&nbsp;
			</tr>
			<tr>
				...
				<td>手机号：<input type="text" name="sMobil" value=<%=sMobil%> /></td>
				<td>&nbsp;</td>
				<td>地址：<input type="text" name="sAddress" value=<%=sAddress%> /></td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>系部：<input type="text" value=<%=sdId%> readonly="true" /></td>
				<td>&nbsp;</td>
				<td>班级：<input type="text" value=<%=sClass%> readonly="true" /></td>
			</tr>
			<tr>&nbsp;
			</tr>
