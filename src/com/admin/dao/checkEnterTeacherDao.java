...
public class checkEnterTeacherDao {
	public int login(String teaID,String teaName,String teaSex,String teaAge,String teaedu,String teatitle,String teaSchool,String teaHealth,String teaPass,String teaDid) {//1:插入成功 0:插入失败 (用户名或密码有误) -1代表系统异常
