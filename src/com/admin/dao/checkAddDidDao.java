...
public class checkAddDidDao {
	public int login(String dId,String dName) {//1:插入成功 0:插入失败 (用户名或密码有误) -1代表系统异常
		...
		try{
			...
			String sql="insert into department(dId,dName) values ('"+dId+"','"+dName+"')";
