...
public class checkQuitCourseDao {
	public int login(String cId,String sId) {//1:插入成功 0:插入失败 (用户名或密码有误) -1代表系统异常
		...
		try{
			...
			String sql="delete from choosecourse where cId='"+cId+"' and sId='"+sId+"'";
