...
public class checkSelectCourseDao {
	
	public int login(String cId,String sId,String grade) {//1:插入成功 0:插入失败 (用户名或密码有误) -1代表系统异常
		...
		try{
			...
			String sql="insert into choosecourse(cId,sId,grade) values('"+cId+"','"+sId+"','"+grade+"')";
